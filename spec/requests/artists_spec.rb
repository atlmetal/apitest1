...
RSpec.describe "/artists", type: :request do
  ...
  # ArtistsController, or in your router and rack
  ...
  describe "GET /index" do
    it "renders a successful response" do
      ...
      get artists_url, headers: valid_headers, as: :json
  ...
  describe "POST /create" do
    context "with valid parameters" do
      it "creates a new Artist" do
        expect {
          post artists_url,
               params: { artist: valid_attributes }, headers: valid_headers, as: :json
    ...
    context "with invalid parameters" do
      it "does not create a new Artist" do
        expect {
          post artists_url,
               params: { artist: invalid_attributes }, as: :json
        }.to change(Artist, :count).by(0)
      end

      it "renders a JSON response with errors for the new artist" do
        post artists_url,
             params: { artist: invalid_attributes }, headers: valid_headers, as: :json
  ...
  describe "DELETE /destroy" do
    it "destroys the requested artist" do
      artist = Artist.create! valid_attributes
      expect {
        delete artist_url(artist), headers: valid_headers, as: :json
      }.to change(Artist, :count).by(-1)
    end
  end
end
